...
const CRISIS_RESPONSE = `Main samajh sakta hoon ki aap bahut kathin samay se guzar rahe hain. Aapki peeda valid hai.
...
Aap akele nahi hain. Ek phone call se bahut fark pad sakta hai. Please call karein.`;
...
app.post('/api/chat', optionalAuth, checkMessageLimit, async (req, res) => {
  ...
  if (detectCrisis(message)) {
    ...
    res.flushHeaders();
    res.write(`data: ${JSON.stringify({ text: CRISIS_RESPONSE })}\n\n`);
    res.write('data: [DONE]\n\n');
    return res.end();
  }
